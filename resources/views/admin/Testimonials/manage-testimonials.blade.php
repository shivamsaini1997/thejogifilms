                                ...
                                <table class="display" id="basic-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <img style="width: 60px;" src="{{asset($item->testimonial_image)}}" alt="">
                                            ...
                                            <td>{{$item->discreption}}</td>
                                             ...
                                             <td>
                                                ...
                                                @if ($item->status == '1')
                                                    <a href="{{route('status-testimonials', ['id' => $item->id, 'status' => '0'])}}" onclick="return confirm('Are you sure!')">
                                                        <span class="badge rounded-pill badge-success">Active</span>
                                                    </a>
                                                @endif
                                               
                                                @if ($item->status == '0')
                                                <a href="{{route('status-testimonials', ['id' => $item->id, 'status' => '1'])}}" onclick="return confirm('Are you sure!')">
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit">
                                                        <a href="{{route('edit-testimonials',['id' => $item->id])}}">
                                                    ...
                                                    <li class="delete ps-2">
                                                        <a href="{{route('delete-testimonials',['id' => $item->id])}}" class="open-detele-modal" type="button" data-bs-toggle="modal" data-bs-target="#tooltipmodal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="mt-2"> Are you sure want to delete this Testimonial</p>

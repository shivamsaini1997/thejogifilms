                                ...
                                <table class="display" id="basic-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img style="width: 60px;" src="{{asset($item->team_image)}}" alt="">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit">
                                                        <a href="{{route('edit-team',['id' => $item->id])}}">
                                                    ...
                                                    <li class="delete ps-2">
                                                        <a href="{{route('delete-team',['id' => $item->id])}}" class="open-detele-modal" type="button" data-bs-toggle="modal" data-bs-target="#tooltipmodal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="mt-2"> Are you sure want to delete this Team</p>

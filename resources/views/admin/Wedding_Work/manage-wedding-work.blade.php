...
@push('title')
    <title>Manage Wedding Work</title>
@endpush
@section('content')
    <div class="page-body">
                                ...
                                <table class="display" id="basic-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img style="width: 60px;" src="{{asset($item->work_image)}}" alt="">
                                            </td>
                                            <td>
                                                
                                                @if ($item->status == '1')
                                                    <a href="{{route('status-wedding-work', ['id' => $item->id, 'status' => '0'])}}" onclick="return confirm('Are you sure!')">
                                                        <span class="badge rounded-pill badge-success">Active</span>
                                                    </a>
                                                @endif
                                               
                                                @if ($item->status == '0')
                                                <a href="{{route('status-wedding-work', ['id' => $item->id, 'status' => '1'])}}" onclick="return confirm('Are you sure!')">
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit">
                                                        <a href="{{route('edit-wedding-work',['id' => $item->id])}}">
                                                    ...
                                                    <li class="delete ps-2">
                                                        <a href="{{route('delete-wedding-work',['id' => $item->id])}}" class="open-detele-modal" type="button" data-bs-toggle="modal" data-bs-target="#tooltipmodal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="mt-2"> Are you sure want to delete this Wedding Work</p>
